...
/*
the dangling else problem occurs when an amibiguity is present in deciding which else corresponds to 
the right if.
in c++ it is resolved by matching every else with the closest preceding unmatched if.*/
int main() {
